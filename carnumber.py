...
def writescv(x):
    with open("D:\Desktop\MatrixC.csv", "w" ,newline="") as csvfile:
        writer = csv.writer(csvfile)
        writer.writerows(dataC)
    with open("D:\Desktop\MatrixX.csv", "w",newline="") as csvfile:
        writer = csv.writer(csvfile)
        writer.writerows(x)
...
if __name__ == "__main__":
    ...
    while T > math.pow(10,-30):
        ...
        temptargetmin = sumCarnumber(tempx)
